...
const ShareIcons = (props: Props) => {
  return (
    <div className='flex flex-wrap items-center justify-between'>
      <a
        href={`https://www.facebook.com/sharer/sharer.php?u=${props.baseURL}/explore/${props.slug}&src=sdkpreparse`}
        rel='noreferrer'
        target='_blank'
      ...
      <a
        href={`https://twitter.com/intent/tweet?text=${props?.title}&url=${props.baseURL}/explore/${props.slug}`}
        target='_blank'
        title='Share on Facebook'
        rel='noreferrer'
      ...
      <a
        href={`https://www.linkedin.com/shareArticle?mini=true&url=${props.baseURL}/explore/${props.slug}&title=${props?.title}&source=andyblog-lake.vercel.app&summary=${props?.body}`}
        target='_blank'
        title='Share on Facebook'
        rel='noreferrer'
      ...
      <a
        href={`https://www.reddit.com/submit?url=${props.baseURL}/explore/${props.slug}`}
        target='_blank'
        title='Share on Facebook'
        rel='noreferrer'
      ...
      <a
        href={`http://share.flipboard.com/bookmarklet/popout?v=2&title=${props?.title}&url=${props.baseURL}/explore/${props.slug}&utm_campaign=tools&utm_medium=article-share&utm_source=andyblog-lake.vercel.app`}
        target='_blank'
        title='Share on Facebook'
        rel='noreferrer'
      ...
      <button
        type='button'
        onClick={() =>
          handleCopy(`${props.baseURL}/explore/${props.slug}`)
        }
        title='Share on Facebook'
      ...
      <a
        href={`mailto:?Subject=${props?.title}&Body=Check this out ${props.baseURL}/explore/${props.slug}`}
        target='_blank'
        title='Share on Facebook'
        rel='noreferrer'
